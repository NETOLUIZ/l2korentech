...
BEGIN
	INSERT INTO buffer_schemes (object_id, scheme_name, skills) VALUES
		(NEW.obj_Id, 'warrior', '1086,1242,1077,1268,1068,1040,1036,1035,1045,1204,1240,1087,1062,271,274,275,264,269,304,1363'),
		(NEW.obj_Id, 'mage', '1085,1059,1040,1036,1035,1045,1048,1204,1078,1062,1303,1354,273,276,365,264,267,304,1413');
END$$
DELIMITER ;
