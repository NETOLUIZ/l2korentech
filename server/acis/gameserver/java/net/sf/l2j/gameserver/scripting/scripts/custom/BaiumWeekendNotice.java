 ...
 * the church) every Saturday and Sunday at 00:00.
 */
public class BaiumWeekendNotice extends Quest
{
	...
	{
		player.sendPacket(new ExShowScreenMessage("Baium aparece em Gludin (em frente a igreja) todo Sabado e Domingo as 00:00!", 8000));
		return null;
	}
}
