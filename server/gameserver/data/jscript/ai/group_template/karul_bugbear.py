...
class karul_bugbear(JQuest) :
    ...
    def onAttack (self,npc,player,damage,isPet):
        ...
        if self.FirstAttacked:
           if Rnd.get(4) : return
           npc.broadcastPacket(CreatureSay(objId,0,"Karul Bugbear","Your rear is practically unguarded!"))
        else :
           self.FirstAttacked = True
           if Rnd.get(4) : return
           npc.broadcastPacket(CreatureSay(objId,0,"Karul Bugbear","Watch your back!"))
        return 
