...
class turek_orc_footman(JQuest) :
    ...
    def onAttack (self,npc,player,damage,isPet):
        ...
        if self.FirstAttacked:
           ...
           npc.broadcastPacket(CreatureSay(objId,0,"Turek Orc Footman","There is no reason for you to kill me! I have nothing you need!."))
        else :
           self.FirstAttacked = True
           npc.broadcastPacket(CreatureSay(objId,0,"Turek Orc Footman","We shall see about that!."))
        return 
