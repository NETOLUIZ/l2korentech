...
class cats_eye_bandit(JQuest) :
    ...
    def onAttack (self,npc,player,damage,isPet):
        ...
        if self.FirstAttacked:
           ...
           npc.broadcastPacket(CreatureSay(objId,0,"Cats Eye Bandit","You childish fool, do you think you can catch me?."))
        else :
    ...
    def onKill (self,npc,player,isPet):
        ...
        if npcId == self.cats_eye_bandit:
            objId=npc.getObjectId()
            if Rnd.get(80) : npc.broadcastPacket(CreatureSay(objId,0,"Cats Eye Bandit","I must do something about this shameful incident ..."))
