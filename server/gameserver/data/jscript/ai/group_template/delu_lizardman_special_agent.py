...
class delu_lizardman_special_agent(JQuest) :
    ...
    def onAttack (self,npc,player,damage,isPet):
        ...
        if self.FirstAttacked:
           ...
           npc.broadcastPacket(CreatureSay(objId,0,"Delu Lizardman Special Agent","Hey! Were having a duel here!"))
        else :
           self.FirstAttacked = True
           npc.broadcastPacket(CreatureSay(objId,0,"Delu Lizardman Special Agent","How dare you interrupt our fight!  Hey guys, help!."))
        return 
