...
class turek_orc_warlord(JQuest) :
    ...
    def onAttack (self,npc,player,damage,isPet):
        ...
        if self.FirstAttacked:
           ...
           npc.broadcastPacket(CreatureSay(objId,0,"Turek Orc Warlord","You wont take me down easily."))
        else :
           self.FirstAttacked = True
           npc.broadcastPacket(CreatureSay(objId,0,"Turek Orc Warlord","The battle has just begun!."))
        return 
