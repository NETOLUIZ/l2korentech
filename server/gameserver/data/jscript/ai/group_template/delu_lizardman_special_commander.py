...
class delu_lizardman_special_commander(JQuest) :
    ...
    def onAttack (self,npc,player,damage,isPet):
        ...
        if self.FirstAttacked:
           ...
           npc.broadcastPacket(CreatureSay(objId,0,"Delu Lizardman Special Commander","Come on, Ill take you on!"))
        else :
           self.FirstAttacked = True
           npc.broadcastPacket(CreatureSay(objId,0,"Delu Lizardman Special Commander","How dare you interrupt a sacred duel! You must be taught a lesson!"))
        return 
