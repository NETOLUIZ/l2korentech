...
class Quest (JQuest) :
 ...
 def onTalk (Self,npc,player):
   htmltext = "<html><head><body>You are either not carrying out your quest or don't meet the criteria</body></html>"
   st = player.getQuestState(qn)
...
print "QuestManager: Importing Repent Your Sins Data."
