...
'637_ThroughOnceMore',
'641_AttackSailren',
'642_APowerfulPrimevalCreature',
'643_RiseAndFallOfTheElrokiTribe',
...
print ""
print "QuestManager: Importing Quest Data Please Wait..."
for name in __all__ :
    try :
        __import__('data.jscript.quests.'+name,globals(), locals(), ['__init__'], -1)
    except:
        print "QuestManager: Failed To Import Quest Data: ",name
print "QuestManager: All Quest Data Load Complete."
print ""
