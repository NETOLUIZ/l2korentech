...
print ""
print "VillageManager: Importing Village Data Please Wait..."
for name in __all__ :
    try :
        __import__('data.jscript.village_master.'+name,globals(), locals(), ['__init__'], -1)
    except:
        print "VillageManager: Failed To Import Village Data: ",name
print "VillageManager: All Village Data Load Complete."
print ""
