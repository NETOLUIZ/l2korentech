...
L2jnet only supports L2jnet software obtained directly from L2jnet forum.

What this means is, if you obtained L2jnet from a source other than our forum,
...
WARNING: L2jnet Server is not a plug and play type of server. 
...
Whereas L2jnet is distributed under the terms of GNU/GPL, we require you to:
a) Preserve logon notice. This gives us, L2jnet Developers, appropriate
...
all config files are in : /gameserver/config/
...
you need in rates.properties. Do same for other config.
...
- You will find all commands in admin main interface.
...
Web: http://L2jnetproject.org/members/
...
no point in coming to our forum if you need items/adena/whatever ingame.
...
Bugs need to be reported on our forum
- http://www.L2jnet.net/

Basic rules for reporting are:
    Please report only one bug/issue per post !
...
Please do NOT report bugs related to un-official add-ons of L2jnet.
...
Contact : - http://www.L2jnet.net/

Have fun playing with L2jnet Packs  ;)
Regards, Dev Team
