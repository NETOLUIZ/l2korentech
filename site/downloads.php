...
<section class="section">
  ...
  <div class="grid">
    ...
    <div class="card feature-card">
      ...
      <h3>System Atualizado (Windows 10)</h3>
      <p>Pasta system atualizada pra quem usa Windows 10 e tem problema pra abrir o cliente.</p>
      <a class="btn btn-primary" style="margin-top:12px;" href="https://drive.google.com/file/d/1PwwxO-SXS4t4jtNPTJvZclBe9WefIeZu/view?usp=sharing" target="_blank" rel="noopener">Baixar System</a>
    </div>
  </div>
</section>
